...
* ``GET /docs/agent``   -- versioned JSON agent guide
* ``GET /agent-docs``   -- Markdown agent guide
* ``GET /agent-docs/api-reference`` -- Markdown API reference
* ``GET /llms.txt``     -- plain-text discovery index
...
from .documentation import equipment_documentation, router as documentation_router
...
def create_app(
    *,
    ...
    # ------------------------------------------------------------------
    # Documentation surface (Markdown agent guide, API reference, llms.txt).
    # Mounted before the spec routes because it is the surface an agent hits
    # first; needs no claim and touches no hardware.
    # ------------------------------------------------------------------
